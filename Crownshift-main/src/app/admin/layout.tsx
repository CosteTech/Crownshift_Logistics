      ...
      <body>
        <div className="flex h-screen bg-gray-100">
          ...
          <div className="flex-grow flex flex-col overflow-hidden">
            ...
            <footer className="h-12 bg-white border-t flex items-center justify-center text-gray-400 text-xs tracking-wider">© 2025 CROWNSHIFT LOGISTICS LTD. ALL RIGHTS RESERVED</footer>
          </div>
        </div>
      </body>
    </html>
